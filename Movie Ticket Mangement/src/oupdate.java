 ...
 * oupdate.java
 *
 * Created on Dec 18, 2017, 11:31:27 PM
 */
 ...
 * @author admin
 */
public class oupdate extends javax.swing.JFrame {

    /** Creates new form oupdate */
    public oupdate() {
        initComponents();
    }
    ...
    try {
        ...
        String sql ="update orders set srno='"+sr+"',ts='"+ts+"',ta='"+ta+"',dis='"+dis+"',na='"+na+"';";
