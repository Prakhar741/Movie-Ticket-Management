 ...
 * save.java
 *
 * Created on Dec 18, 2017, 2:49:53 AM
 */
...
public class save extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 10, 410, 200));
    ...
    try{
        ...
        String sql = "insert into booking values('"+sr+"','"+ts+"','"+ta+"','"+dis+"','"+na+"');";
        stmt.executeUpdate(sql);
        JOptionPane.showMessageDialog(null,"Record Saved successfully");
    }
        catch(Exception e){             
            JOptionPane.showMessageDialog(null,"Record Not successfully");
                           }
